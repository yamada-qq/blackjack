 ...
 * Generated at: 2024-11-25 05:13:22 UTC
...
public final class BlackjackPlayScreen_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if (gameManagement == null || cardManagement == null) {
    ...
    return;
      ...
      out.write("<title>ブラックジャックゲーム</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("    <h1>ラウンド");
      ...
      out.write("	<!--ディーラーの手札  -->\r\n");
      out.write("	ディーラの手札<br>\r\n");
      out.write("	<table>\r\n");
      out.write("		<tr>\r\n");
      out.write("			<td>");
      out.print(cardManagement.getDealerHand().get(0) );
      out.write("</td>\r\n");
      out.write("			<td>&nbsp;</td>\r\n");
      out.write("		</tr>\r\n");
      out.write("	</table>\r\n");
...
for(Trump trumps:cardManagement.getPlayerHand()){ 
      ...
      out.write("	</div>\r\n");
      out.write("\r\n");
      out.write("    <form action=\"PlayerAction\" method=\"post\">\r\n");
      out.write("    ");
if(cardManagement.calculateHandValue(cardManagement.getPlayerHand()) < 21){ 
      out.write("\r\n");
      out.write("        <button type=\"submit\" name=\"action\" value=\"hit\">Hit（もう一枚引く）</button>\r\n");
      out.write("        ");
} 
      out.write("\r\n");
      out.write("        <button type=\"submit\" name=\"action\" value=\"stand\">Stand（勝負する）</button><br>\r\n");
      out.write("\r\n");
      out.write("        ");
...
if(gameManagement.getBetMedal() < gameManagement.getOwnMedal()){ 
      out.write("\r\n");
      out.write("            <button type=\"submit\" name=\"action\" value=\"doubledown\">Double Down（BETを2倍にして、カードを1枚だけ引く）</button><br>\r\n");
      out.write("            ");
} 
      out.write("\r\n");
      out.write("            <button type=\"submit\" name=\"action\" value=\"surrender\">Surrender（BETの半額受け取り次ゲームへ）</button>\r\n");
      out.write("        ");
} 
      out.write("\r\n");
      out.write("    </form>\r\n");
